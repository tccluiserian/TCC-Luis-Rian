...
function CameraCadastro({ route, navigation }) {
            ...
            RNFetchBlob.fs
              ...
              .then(ifstream => {
                ...
                ifstream.onEnd(() => {
                  ...
                  functionsF
                    .httpsCallable('addFaceCollection')({ image: data2, userData: { ...route.params.userData }, organizacaoKey: params.criadorKey })
                    .then(res2 => {
                      console.log(res2);
                      setLoading(false);
